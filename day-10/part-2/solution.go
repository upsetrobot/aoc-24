 ...
 *
 * For part 2, the rating system is based on paths instead of destinations.
 * I think my solution already can do that by not removing duplicates. Let's 
 * see if that's true.
 *
 * file:        solution.go
